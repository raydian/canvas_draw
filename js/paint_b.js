...
function save(onserver) {
  ...
  if(canvas.toDataURL) {
    ...
    if(onserver == true) {
       ...
       alert('Please right-click/save-as to save your drawing. <a href="#" onclick="overlay_hide()">close</a><br /><img src="'+dataurl+'" title="Please right-click/save-as" />'); 
    }
...
function saveonline(dataurl) {
	...
	req.onreadystatechange = function() { 
        ...
        alert('Your image has been saved as <input size="50" value="http://canvaspaint.org/'+response+'"> <a href="#" onclick="overlay_hide()">close</a><br /><img src="http://canvaspaint.org/'+response+'" />'); 
			}	else {
